...
static const char qt_meta_stringdata_WorkerThread[] = {
    "WorkerThread\0\0fileName,result,chunk\0"
    "progressChanged(QString,int,int)\0"
    "fileName\0overwriteFileSignal(QString)\0"
    "folder\0finished(QString)\0"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->progressChanged((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->overwriteFileSignal((*reinterpret_cast< QString(*)>(_a[1]))); break;
...
// SIGNAL 0
void WorkerThread::progressChanged(QString _t1, int _t2, int _t3)
{
...
// SIGNAL 1
void WorkerThread::overwriteFileSignal(QString _t1)
{
...
// SIGNAL 2
void WorkerThread::finished(QString _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
